import { Guild, GuildMember, GuildResolvable, Message, PartialMessage } from "discord.js";
import { log } from "./logger";
import { client } from "../app";
import props from "../props";
import { Interaction } from "../";

export const createError = async (location: string, body: string | Error, ref?: { guild?: GuildResolvable; message?: Message | PartialMessage; interaction?: Interaction; member?: GuildMember }) => {
  try {
    let guild: Guild;
    if (ref) {
