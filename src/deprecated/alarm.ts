// import { Interaction, VoiceBroadcast, VoiceChannel, VoiceState } from "discord.js";
...
//     if (method === "subscribe") {
//       try {
//         const voiceState: VoiceState = client.guilds.resolve(interaction.guildId).members.resolve(interaction.member.user.id).voice;
